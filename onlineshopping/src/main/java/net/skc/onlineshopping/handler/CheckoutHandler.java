...
import net.skc.onlineshopping.model.CheckoutModel;
...
import net.skc.shoppingbackend.dto.OrderDetail;
import net.skc.shoppingbackend.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public String saveAddress(CheckoutModel checkoutModel, Address shipping) {
		...
		User user = new User();
		user.setId(checkoutModel.getUser().getId());
