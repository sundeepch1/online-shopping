...
/*	@Test
	public void testGetCategory() {
		...
		assertEquals("Successfully get a category from the table!","Television",category.getName());
...
/*	@Test
	public void testUpdateCategory() {
		Category category = categoryDAO.get(1);
		category.setName("Television");
		assertEquals("Successfully update a category in the table!",true, categoryDAO.update(category));
...
/*	
	...
	public void testDeleteCategory() {
		Category category = categoryDAO.get(1);
		assertEquals("Successfully delete a category from the table!",true, categoryDAO.delete(category));
